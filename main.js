...
var Party = /** @class */ (function () {
    function Party(dish, guest) {
        this._dishes = dish;
        this._guest = guest;
    }
    Object.defineProperty(Party.prototype, "dish", {
        set: function (newDish) {
...
var partyIns = new Party(10, 30);
// console.log(partyIns._dishes)
// console.log(partyIns._guest)
partyIns.dish = 12;
console.log(partyIns._dishes);
console.log(partyIns._guest);
